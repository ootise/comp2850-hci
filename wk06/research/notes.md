...
**Context**: [perfers dark mode, likes keyboard, glasses-wearer]
**Consent**: ✅ Confirmed verbally
**Duration**: [~10 minutes]

### Q1: When was the last time you used a task manager - what on was used
**Response**: "Used last Friday (14.11.25). Participant A used them for their shopping. The notepad app"
...
**Response**: "Looks ugly and everything has rounded edges; Folders are annoying to use so it's hard to organise things "
...
**Response**: "Yeah, forgot when *my* bursary was due"
...
### Q5: No glasses on / bright sunlight?
**Response**: "Font can be changed to help with vision; Would say I do struggle to use app in bright sunlight"
...
**Themes**: `contrast`, `zoom`, `responsive_design to light`
...
**Observations**:
- often juggles tasks mentally
- doesn't really like to use digital task managers 


**Themes**: `app should be engaging and easy to use to encourage usage`
...
**Observations**:
- Lack of good fonts -> potentially have option to change fonts
- try to mimic feeling of pen and paper as much as possible

**Themes**: `have different fonts to deal with readability and engagment`

### Q3: Lost track of important task?
**Response**: "Probably. Not had much experience with an app"
...
**Observations**:
- app needs to be able to function with just keyboard on desktop/laptop devices


**Themes**: `keyboard_nav`, `temporary_impairment`, `button_accessibility`


### Q5: bright sunlight or potential undiagnosed austism makes it hard to concentrate?
